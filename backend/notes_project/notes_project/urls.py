...
urlpatterns = [
    ...
    path('api/auth/password-change/', auth.ChangePasswordView.as_view(), name='password-change'),
    path('api/auth/password-reset/', auth.ResetPasswordview.as_view(), name='password-reset'),
